...
:prose-img{:src="img.src" :alt="img.alt"}
...
:prose-img{src="/v1637023033/Articoli/Gorlu%20la%20stampante/Logo_py_c.png" caption="Loghi di Python e C++"}
...
:prose-img{src="/v1637024651/Articoli/Gorlu%20la%20stampante/Canny.png" caption="Un esempio di utilizzo dell'algoritmo Canny"}
...
:prose-img{src="/v1632851575/Articoli/Gorlu%20la%20stampante/Algoritmo_di_ricerca_1.png" caption="Simulazione grafica dell'algoritmo di ricerca"}
...
:prose-img{src="/v1632851575/Articoli/Gorlu%20la%20stampante/Algoritmo_di_ricerca_2.png" caption="Uno screen dell'algoritmo di ricerca"}
...
:prose-video{src="https://res.cloudinary.com/bocchio/video/upload/v1632851317/Articoli/Gorlu%20la%20stampante/Movimento_carrelli.mp4" caption="Scorrimento dei due carrelli"}
...
:prose-video{src="https://res.cloudinary.com/bocchio/video/upload/v1632851576/Articoli/Gorlu%20la%20stampante/Movimento_penna.mp4" caption="Il meccanismo per alzare e abbasare la penna"}
...
:prose-i-frame{src="https://www.youtube.com/embed/qBS6WiSzQmI" caption="Stampa di Pikachu"}
