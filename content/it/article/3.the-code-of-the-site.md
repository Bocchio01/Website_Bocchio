...
:media{s="/v1655593847/Articoli/Il%20codice%20del%20sito/Gif_old_site.gif" c="Pagina di benvenuto del vecchio sito"}
...
:media{s="https://www.youtube.com/embed/nhBVL41-_Cw" c="Panoramica del Framework Vue" type="iframe"}
...
:media{s="/v1657554206/Articoli/Il%20codice%20del%20sito/FuochiArtificioBocchio.png" c="Accurata rappresetazione del mio stato d'animo :)"}
...
:media{s="/v1657558786/Articoli/Il%20codice%20del%20sito/Repository.png" c="Root del progetto"}
...
:media{s="/v1657622148/Articoli/Il%20codice%20del%20sito/MySQL-Logo.jpg" c="Logo MySQL"}
...
:media{s="https://bocchioutils.altervista.org/BWS/site/analytics.php?l=it&isStatistics=1" a="Analytics page" type="iframe"}
...
:media{s="https://bocchio.dev/.netlify/functions/og-image?title=Barbatrucco!&theme=dark" c="Immagine generata ora dal server" provider=""}
