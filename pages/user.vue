...
<template>
            ...
            <div>
                <div v-show="tags_to_view[0] || tags_to_view[1]" class="tooltip">
                    ...
                    <div v-show="tags_to_view[0]">
                        ...
                        <input id="nickname" type="text" :value="user.nickname" @input="updateVal($event, 'nickname')"
                            required placeholder="Es: Bocchio01" />
                    </div>
                    ...
                    height: calc(7px + var(--Size_Text_Wrap));
                    vertical-align: top;
                    cursor: pointer;
                    margin-right: 5px;
                  " @click="ShowPassword()">
                    ...
                    <div style="margin-top: 0; color: #a2a2a2" v-show="tags_to_view[1]">
                        <p>
                            ...
                            <a :href="utils_site +
                                ...
                                " target="_blank" rel="nofollow noopener noreferrer" style="color: #a2a2a2">{{
        $t('cLogin.login.forgotpassword.1') }}</a>
                        </p>
                    </div>
                ...
                <div v-show="tags_to_view[2]" class="tooltip">
                    ...
                    <p style="color: #a2a2a2">
                        ...
                        <a :href="utils_site +
                            ...
                            " target="_blank" rel="nofollow noopener noreferrer" style="color: #a2a2a2">{{
        $t('cLogin.settings_user.modifypassword.1') }}</a>
                    </p>
                    ...
                    <div class="inline">
                        ...
                        <button style="visibility: hidden; height: 0px; padding-block: 0px">
                            {{ $t('cLogin.button.to_default') }}
                        </button>
                    </div>

                    <div class="inline">
                        <label for="mod_lang">{{
                            $t('cLogin.settings_user.lang.label')
                        }}</label>

                        <nuxt-link style="text-align: center"
                            :to="switchLocalePath($t('cLogin.settings_user.lang.switch.iso'))">
                            <img :src="require('~/assets/png/Lang/' +
                                $t('cLogin.settings_user.lang.switch.img'))
                    ...
                    <div class="inline">
                        ...
                        <img id="avatar" :src="require('@/assets/png/Avatar' + user.preferences.avatar)"
                            alt="AvatarSelected" @click="show_avatar = !show_avatar" />
    ...
    <label for="mod_newsletter">
        <input type="checkbox" id="mod_newsletter" :checked="user.preferences.newsletter" @click="
            updateVal(
    ...
    <div class="inline no-button">
        ...
        <div>
            <div @click="updateVal('light', 'preferences.theme')">
                ...
                <label for="light">
                    <span></span> {{ $t('cLogin.settings_site.theme.2') }}
                </label>
            </div>
            <div @click="updateVal('dark', 'preferences.theme')">
                <input id="dark" type="radio" :checked="user.preferences.theme == 'dark'" />
                <label for="dark">
                    <span></span> {{ $t('cLogin.settings_site.theme.1') }}
                </label>
            </div>
        </div>

        <button @click="updateVal('light', 'preferences.theme')">
            {{ $t('cLogin.button.to_default') }}
        </button>
    </div>
    ...
    <div class="inline">
        ...
        <button @click="updateVal('#ff9800', 'preferences.color')">
            {{ $t('cLogin.button.to_default') }}
        </button>
    </div>
