<template>
  <div
    class="msg_bg"
    :class="[$store.state.show.login ? 'visible' : 'hidden']"
      ...
      <div>
        <div v-show="tags_to_view[0] || tags_to_view[1]" class="tooltip">
          ...
          <div
            ...
            v-show="tags_to_view[0] || tags_to_view[1]"
          >
          ...
          <div v-show="tags_to_view[1]">
            <label for="autologin">
              <input
                ...
                @click="updateVal(!user.autologin, 'autologin')"
        ...
        <div v-show="tags_to_view[2]" class="tooltip">
          ...
          <div class="inline">
            ...
            <img
              id="avatar"
              :src="require('@/assets/png/Avatar' + user.preferences.avatar)"
              alt="AvatarSelected"
...
<script>
  export default {
    ...
    mounted() {
      document.getElementById('autologin').checked = JSON.parse(
